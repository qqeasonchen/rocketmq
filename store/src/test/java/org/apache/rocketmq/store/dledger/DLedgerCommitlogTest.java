...
public class DLedgerCommitlogTest extends MessageStoreTestBase {
    private static final char NAME_VALUE_SEPARATOR = 1;
    private static final char PROPERTY_SEPARATOR = 2;
    ...
    private String messageProperties2String(Map<String, String> properties) {
